                ...
                <div class="card shadow">
                    <div class="card-body">
                        <div class="mar-ver pad-btm text-center">
                            <h1 class="h3">Database setup for Flowerly</h1>
                        ...
                        <form method="POST" action="{{ route('installation.storeDbSetup') }}">
                            ...
                            <div class="form-group mb-2">
                                ...
                                <input type="text" class="form-control" id="db_host" name="DB_HOST" value="flowerly-do-user-8280720-0.b.db.ondigitalocean.com"
                                    autocomplete="off" required>
                                <input type="hidden" name="types[]" value="DB_HOST">
                            </div>
                            <div class="form-group mb-2">
                                <label class="fw-semibold mb-1" for="db_port">Database Port</label>
                                <input type="text" class="form-control" id="db_port" name="DB_PORT" value="25060"
                            ...
                            <div class="form-group mb-2">
                                ...
                                <input type="text" class="form-control" id="db_name" name="DB_DATABASE" value="flowerly"
                                    autocomplete="off" required>
                                <input type="hidden" name="types[]" value="DB_DATABASE">
                            </div>
                            <div class="form-group mb-2">
                                <label class="fw-semibold mb-1" for="db_user">Database Username</label>
                                <input type="text" class="form-control" id="db_user" name="DB_USERNAME" value="doadmin" required autocomplete="off">
                                <input type="hidden" name="types[]" value="DB_USERNAME">
                            </div>
                            <div class="form-group mb-2">
                                <label class="fw-semibold mb-1" for="db_pass">Database Password</label>
                                <input type="password" class="form-control" id="db_pass" name="DB_PASSWORD" value="AVNS_Eh8tmaeKYZhoe3i3Lun"
                                    autocomplete="off">
