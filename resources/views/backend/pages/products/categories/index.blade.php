...
@section('title')
    {{ localize('Occasions') }} {{ getSetting('title_separator') }} {{ getSetting('system_title') }}
@endsection
                    ...
                    <div class="card tt-page-header">
                        <div class="card-body d-lg-flex align-items-center justify-content-lg-between">
                            <div class="tt-page-title">
                                <h2 class="h5 mb-lg-0">{{ localize('Occasions') }}</h2>
                            </div>
                            <div class="tt-action">
                                @can('add_categories')
                                    <a href="{{ route('admin.categories.create') }}" class="btn btn-primary"><i
                                            data-feather="plus"></i> {{ localize('Add Occasion') }}</a>
                                @endcan
                            </div>
                        </div>
                    </div>
